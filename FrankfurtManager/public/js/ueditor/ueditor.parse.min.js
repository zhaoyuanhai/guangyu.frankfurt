...
!function () {
    !function () {
        UE = window.UE || {};
        var a = !!window.ActiveXObject, b = { removeLastbs: function (a) { return a.replace(/\/$/, ""); }, extend: function (a, b) {
                ...
                }(), window.attachEvent("onload", function () { b(); })) : (c.addEventListener("DOMContentLoaded", function () { c.removeEventListener("DOMContentLoaded", arguments.callee, !1), b(); }, !1), window.addEventListener("load", function () { b(); }, !1));
            }, each: function (a, b, c) {
                if (null != a)
            ...
            }, pushItem: function (a, b) { this.inArray(a, b) == -1 && a.push(b); }, trim: function (a) { return a.replace(/(^[ \t\n\r]+)|([ \t\n\r]+$)/g, ""); }, indexOf: function (a, b, c) {
                var d = -1;
                ...
                return function (c, d, e) {
                    ...
                    if (!d.id || !c.getElementById(d.id)) {
                        ...
                        }, i.onerror = function () { throw Error("The load " + (d.href || d.src) + " fails,check the url"); }, c.getElementsByTagName("head")[0].appendChild(i);
                    }
                };
            }() };
        b.each(["String", "Function", "Array", "Number", "RegExp", "Object", "Boolean"], function (a) { b["is" + a] = function (b) { return Object.prototype.toString.apply(b) == "[object " + a + "]"; }; });
        var c = {};
        UE.parse = { register: function (a, b) { c[a] = b; }, load: function (a) { b.each(c, function (c) { c.call(a, b); }); } }, uParse = function (a, c) {
            b.domReady(function () {
                var d;
                if (document.querySelectorAll)
                    ...
                    var d = [];
                    b.each(document.getElementsByTagName("*"), function (b) { b.className && new RegExp("\\b" + a.replace(/^\./, "") + "\\b", "i").test(b.className) && d.push(b); });
                }
                else
        ...
        function c(b, c, e) {
            for (var f = b.rows, g = [], h = "TH" === f[0].cells[0].tagName, i = 0, j = 0, k = f.length; j < k; j++)
                g[j] = f[j];
            var l = { reversecurrent: function (a, b) { return 1; }, orderbyasc: function (a, b) { var c = a.innerText || a.textContent, d = b.innerText || b.textContent; return c.localeCompare(d); }, reversebyasc: function (a, b) { var c = a.innerHTML, d = b.innerHTML; return d.localeCompare(c); }, orderbynum: function (b, c) { var d = b[a.isIE ? "innerText" : "textContent"].match(/\d+/), e = c[a.isIE ? "innerText" : "textContent"].match(/\d+/); return d && (d = +d[0]), e && (e = +e[0]), (d || 0) - (e || 0); }, reversebynum: function (b, c) { var d = b[a.isIE ? "innerText" : "textContent"].match(/\d+/), e = c[a.isIE ? "innerText" : "textContent"].match(/\d+/); return d && (d = +d[0]), e && (e = +e[0]), (e || 0) - (d || 0); } };
            b.setAttribute("data-sort-type", e && "string" == typeof e && l[e] ? e : ""), h && g.splice(0, 1), g = d(g, function (a, b) { var d; return d = e && "function" == typeof e ? e.call(this, a.cells[c], b.cells[c]) : e && "number" == typeof e ? 1 : e && "string" == typeof e && l[e] ? l[e].call(this, a.cells[c], b.cells[c]) : l.orderbyasc.call(this, a.cells[c], b.cells[c]); });
            ...
            a.each(b, function (b) {
                if (b.className && /custom_/i.test(b.className)) {
                    ...
                    if ("dash" == f || "dot" == f)
                        ...
                        var g = 1;
                        a.each(b.childNodes, function (b) { "LI" == b.tagName && (a.pushItem(c, h + " li.list-" + d[f] + g + "{background-image:url(" + e.liiconpath + "list-" + d[f] + g + ".gif)}"), g++); }), a.pushItem(c, h + " ol.custom_" + f + "{list-style:none;}" + h + " ol.custom_" + f + " li{background-position:0 3px;background-repeat:no-repeat}");
                    }
                    switch (f) {
                        case "cn":
                        ...
                        case "dash":
                            ...
                            break;
                        case "dot": a.pushItem(c, h + " li.list-" + f + "-paddingleft{padding-left:20px}");
                    }
                }
            });
        }
