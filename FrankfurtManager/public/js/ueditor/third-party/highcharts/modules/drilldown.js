    ...
    o(e.Series.prototype, "drawDataLabels", function (b) {
        ...
        g(this.points, function (b) {
            if (b.drilldown && b.dataLabel)
                b.dataLabel.attr({ "class": "highcharts-drilldown-data-label" }).css(a).on("click", function () { b.doDrilldown(); });
        });
    });
    l.prototype.supportsDrilldown = !0;
    k.prototype.supportsDrilldown = !0;
    var p, j = function (b) { b.call(this); g(this.points, function (a) { a.drilldown && a.graphic && a.graphic.attr({ "class": "highcharts-drilldown-point" }).css({ cursor: "pointer" }); }); };
    for (p in i)
