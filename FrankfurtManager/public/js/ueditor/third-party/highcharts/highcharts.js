...
(function () {
    ...
    function U(a, b, c, d, e) { a = y.createElement(a); b && r(a, b); e && K(a, { padding: 0, border: S, margin: 0 }); c && K(a, c); d && d.appendChild(a); return a; }
    function ha(a, b) { var c = function () { }; c.prototype = new a; r(c.prototype, b); return c; }
    function Aa(a, b, c, d) {
    ...
    function mb(a, b, c) { var d = a[b]; a[b] = function () { var a = Array.prototype.slice.call(arguments); a.unshift(d); return c.apply(this, a); }; }
    function Ca(a, b) {
    ...
    function Ta(a) { cb || (cb = U(Ea)); a && cb.appendChild(a); cb.innerHTML = ""; }
    function ka(a, b) {
    ...
    function Lb() { var a = M.global.useUTC, b = a ? "getUTC" : "get", c = a ? "setUTC" : "set"; bb = a ? Date.UTC : function (a, b, c, g, h, i) { return (new Date(a, b, o(c, 1), o(g, 0), o(h, 0), o(i, 0))).getTime(); }; qb = b + "Minutes"; rb = b + "Hours"; tb = b + "Day"; Sa = b + "Date"; $a = b + "Month"; ab = b + "FullYear"; Fb = c + "Minutes"; Gb = c + "Hours"; sb = c + "Date"; Hb = c + "Month"; Ib = c + "FullYear"; }
    function wa() { }
    function Ma(a, b, c, d) { this.axis = a; this.pos = b; this.type = c || ""; this.isNew = !0; !c && !d && this.addLabel(); }
    function vb(a, b) {
        this.axis = a;
        if (b)
            this.options =
    ...
    (function (a) {
        O.HighchartsAdapter = O.HighchartsAdapter || a && { init: function (b) {
                ...
                return d;
            }, offset: function (b) { return a(b).offset(); }, addEvent: function (b, c, d) { a(b).bind(c, d); }, removeEvent: function (b, c, d) {
    ...
    var ra = function (a) {
        ...
        return { get: function (c) { var f; d ? (f = x(a), f.stops = [].concat(f.stops), n(d, function (a, b) { f.stops[b] = [f.stops[b][0], a.get(c)]; })) : f = b && !isNaN(b[0]) ? c === "rgb" ? "rgb(" + b[0] + "," + b[1] + "," + b[2] + ")" : c === "a" ? b[3] : "rgba(" + b.join(",") + ")" : a; return f; }, brighten: function (a) {
                if (d)
                    n(d, function (b) { b.brighten(a); });
                else if (sa(a) && a !== 0) {
                    var c;
                    for (c = 0; c < 3; c++)
    ...
    wa.prototype = { init: function (a, b) { this.element = b === "span" ? U(b) : y.createElementNS(za, b); this.renderer = a; this.attrSetters = {}; }, opacity: 1, animate: function (a, b, c) {
            b = o(b, Fa, !0);
            Wa(this);
            if (b) {
                b = x(b);
        ...
        }, clip: function (a) { return this.attr("clip-path", a ? "url(" + this.renderer.url + "#" + a.id + ")" : S); }, crisp: function (a, b, c, d, e) {
            ...
            var b = this.element, c = a && a.width && b.nodeName.toLowerCase() === "text", d, e = "", f = function (a, b) { return "-" + b.toLowerCase(); };
            if (a && a.color)
                a.fill = a.color;
            ...
            ib && a === "click" ? (d.ontouchstart = function (a) { c.touchEventFired = Date.now(); a.preventDefault(); b.call(d, a); }, d.onclick = function (a) {
                (oa.indexOf("Android") === -1 ||
                    Date.now() - (c.touchEventFired || 0) > 1100) && b.call(d, a);
            }) : d["on" + a] = b;
            return this;
        }, setRadialReference: function (a) { this.element.radialReference = a; return this; }, translate: function (a, b) { return this.attr({ translateX: a, translateY: b }); }, invert: function () { this.inverted = !0; this.updateTransform(); return this; }, htmlCss: function (a) {
            var b = this.element;
            ...
            a.safeRemoveChild(b);
            for (c && n(c, function (b) { a.safeRemoveChild(b); }); d && d.childNodes.length === 0;)
    ...
    Ha.prototype = { Element: wa, init: function (a, b, c, d) {
            ...
            return a;
        }, path: function (a) { var b = { fill: S }; Ia(a) ? b.d = a : T(a) && r(b, a); return this.createElement("path").attr(b); }, circle: function (a, b, c) { a = T(a) ? a : { x: a, y: b, r: c }; return this.createElement("circle").attr(a); }, arc: function (a, b, c, d, e, f) {
            if (T(a))
            ...
            for (this.boxWrapper[o(c, !0) ? "animate" : "attr"]({ width: a, height: b }); e--;)
                d[e].align();
        }, g: function (a) { var b = this.createElement("g"); return u(a) ? b.attr({ "class": "highcharts-" + a }) : b; }, image: function (a, b, c, d, e) {
            ...
            f.text = function (a) { a !== g.innerHTML && delete this.bBox; g.innerHTML = a; return !1; };
                ...
                e.add = function (a) {
                    ...
                    if (a) {
                        if (b = a.div, !b) {
                            ...
                            n(d.reverse(), function (a) { var d; b = a.div = a.div || U(Ea, { className: v(a.element, "class") }, { position: "absolute", left: (a.translateX || 0) + "px", top: (a.translateY || 0) + "px" }, b || c); d = b.style; r(a.attrSetters, { translateX: function (a) { d.left = a + "px"; }, translateY: function (a) { d.top = a + "px"; }, visibility: function (a, b) { d[b] = a; } }); });
                        }
                    }
                    else
                        b = c;
            ...
            function m() { o.add(q); q.attr({ text: a, x: b, y: c }); A && u(e) && q.attr({ anchorX: e, anchorY: f }); }
            ...
            g.height =
                function (a) { la = a; return !1; };
            g.padding = function (a) { u(a) && a !== da && (da = a, k()); return !1; };
            g.paddingLeft = function (a) { u(a) && a !== kb && (kb = a, k()); return !1; };
            g.align = function (a) { s = { left: 0, center: 0.5, right: 1 }[a]; return !1; };
            g.text = function (a, b) { o.attr(b, a); j(); k(); return !1; };
            g[Rb] = function (a, b) { C = !0; B = a % 2 / 2; l(b, a); return !1; };
            g.stroke = g.fill = g.r = function (a, b) { b === "fill" && (C = !0); l(b, a); return !1; };
            g.anchorX = function (a, b) { e = a; l(b, a + B - E); return !1; };
            g.anchorY = function (a, b) { f = a; l(b, a - H); return !1; };
            g.x = function (a) {
                q.x = a;
                a -= s *
                    ((Oa || L.width) + da);
            ...
            g.y = function (a) { H = q.y = t(a); q.attr("translateY", H); return !1; };
            var y = q.css;
            return r(q, { css: function (a) {
                    ...
                    return y.call(q, a);
                }, getBBox: function () { return { width: L.width + 2 * da, height: L.height + 2 * da, x: L.x - da, y: L.y - da }; }, shadow: function (a) { A && A.shadow(a); return q; }, destroy: function () {
                    aa(q, "add", m);
    ...
    if (!Z && !$) {
        ...
        var ma = { Element: F, isIE8: oa.indexOf("MSIE 8.0") > -1, init: function (a, b, c) {
                ...
                if (i) {
                    var k, l, m = a.linearGradient || a.radialGradient, p, q, o, A, L, s = "", a = a.stops, u, t = [], w = function () { h = ['<fill colors="' + t.join(",") + '" opacity="', o, '" o:opacity2="', q, '" type="', i, '" ', s, 'focus="100%" method="any" />']; U(e.prepVML(h), null, null, b); };
                    p = a[0];
                    u = a[a.length - 1];
                    p[0] > 0 && a.unshift([0, p[1]]);
                    u[0] < 1 && a.push([1, u[1]]);
                    n(a, function (a, b) { g.test(a[1]) ? (f = ra(a[1]), k = f.get("rgb"), l = f.get("a")) : (k = a[1], l = 1); t.push(a[0] * 100 + "% " + k); b ? (o = l, A = k) : (q = l, L = k); });
                    if (c === "fill")
                        if (i === "gradient")
                            c = m.x1 || m[0] || 0, a = m.y1 || m[1] || 0, p = m.x2 || m[2] || 0, m = m.y2 || m[3] || 0, s = 'angle="' +
                                (90 - R.atan((m - a) / (p - c)) * 180 / ya) + '"', w();
                        else {
                            var j = m.r, r = j * 2, E = j * 2, H = m.cx, B = m.cy, x = b.radialReference, v, j = function () { x && (v = d.getBBox(), H += (x[0] - v.x) / v.width - 0.5, B += (x[1] - v.y) / v.height - 0.5, r *= x[2] / v.width, E *= x[2] / v.height); s = 'src="' + M.global.VMLRadialGradientURL + '" size="' + r + "," + E + '" origin="0.5,0.5" position="' + H + "," + B + '" color2="' + L + '" '; w(); };
                            d.added ? j() : J(d, "add", j);
                            j = A;
                        }
                    else
            ...
            }, g: function (a) { var b; a && (b = { className: "highcharts-" + a, "class": "highcharts-" + a }); return this.createElement(Ea).attr(b); }, image: function (a, b, c, d, e) { var f = this.createElement("img").attr({ src: a }); arguments.length > 1 && f.attr({ x: b, y: c, width: d, height: e }); return f; }, rect: function (a, b, c, d, e, f) {
                var g = this.symbol("rect");
                g.r =
                    T(a) ? a.r : e;
                return g.attr(T(a) ? a : g.crisp(f, a, b, s(c, 0), s(d, 0)));
            }, invertChild: function (a, b) { var c = b.style; K(a, { flip: "x", left: C(c.width) - 1, top: C(c.height) - 1, rotation: -90 }); }, symbols: { arc: function (a, b, c, d, e) {
    ...
    if ($)
        Highcharts.CanVGRenderer = F = function () { za = "http://www.w3.org/1999/xhtml"; }, F.prototype.symbols = {}, Tb = function () {
            ...
            var b = [];
            return { push: function (c, d) { b.length === 0 && Vb(d, a); b.push(c); } };
        }(), Va = F;
    ...
    vb.prototype = { render: function () {
            ...
            if (u(L))
                d.zIndex = L;
            if (p)
                q ? p.animate({ d: q }, null, p.onGetPath) : (p.hide(), p.onGetPath = function () { p.show(); });
            else if (q && q.length && (a.svgElem = p = w.path(q).attr(d).add(), t))
                for (n in e =
                    function (b) { p.on(b, function (c) { t[b].apply(a, [c]); }); }, t)
                    e(n);
    ...
    db.prototype = { defaultOptions: { dateTimeLabelFormats: { millisecond: "%H:%M:%S.%L", second: "%H:%M:%S", minute: "%H:%M", hour: "%H:%M", day: "%e. %b", week: "%e. %b",
        ...
        }, setTitle: function (a, b) { this.update({ title: a }, b); }, redraw: function () { var a = this.chart.pointer; a.reset && a.reset(!0); this.render(); n(this.plotLinesAndBands, function (a) { a.render(); }); n(this.series, function (a) { a.isDirty = !0; }); }, buildStacks: function () {
    ...
    wb.prototype = { init: function (a, b) {
            ...
            if (g && (N(a - f.x) > 1 || N(b - f.y) > 1))
                clearTimeout(this.tooltipTimeout), this.tooltipTimeout = setTimeout(function () { e && e.move(a, b, c, d); }, 32);
        }, hide: function () {
            var a = this, b;
            clearTimeout(this.hideTimer);
            if (!this.isHidden)
            ...
            c || (n(a, function (a) { i = a.series.yAxis; g += a.plotX; h += (a.plotLow ? (a.plotLow + a.plotHigh) / 2 : a.plotY) + (!e && i ? i.top - f : 0); }), g /= a.length, h /= a.length, c = [e ? d.plotWidth - h : g, this.shared && !e && a.length > 1 && b ? b.chartY - f : e ? d.plotHeight - g :
                    h]);
            return Na(c, t);
            ...
            f = g[0];
            g = g[1];
            m && (!a.series || !a.series.noSharedTooltip) ? (c.hoverPoints = a, h && n(h, function (a) { a.setState(); }), n(a, function (a) { a.setState("hover"); j.push(a.getLabelConfig()); }), h = { x: a[0].category, y: a[0].y }, h.points = j, a = a[0]) : h = a.getLabelConfig();
            i = i.call(h, this);
            h = a.series;
    ...
    xb.prototype = { init: function (a, b) {
            ...
            var h = this.chart, i = a ? "x" : "y", j = a ? "X" : "Y", k = "chart" + j, l = a ? "width" : "height", m = h["plot" + (a ? "Left" : "Top")], p, q, o = 1, n = h.inverted, s = h.bounds[a ? "h" : "v"], t = b.length === 1, u = b[0][k], r = c[0][k], w = !t && b[1][k], v = !t && c[1][k], x, c = function () { !t && N(u - w) > 20 && (o = N(r - v) / N(u - w)); q = (m - r) / o + u; p = h["plot" + (a ? "Width" : "Height")] / o; };
            c();
            b = q;
        ...
        onContainerClick: function (a) {
            ...
            n(c, function (b) { a["_" + b[2]] = function (c) { a[b[2]](c); }; b[1].indexOf("on") === 0 ? b[0][b[1]] = a["_" + b[2]] : J(b[0], b[1], a["_" + b[2]]); });
        }, destroy: function () {
            var a = this;
    ...
    eb.prototype = { init: function (a, b) {
            ...
            this.options = b;
            if (b.enabled)
                c.baseline = C(d.fontSize) + 3 + f, c.itemStyle = d, c.itemHiddenStyle = x(d, b.itemHiddenStyle), c.itemMarginTop = f, c.padding = e, c.initialItemX = e, c.initialItemY = e - 5, c.maxItemWidth = 0, c.chart = a, c.itemHeight = 0, c.lastLineHeight = 0, c.render(), J(c.chart, "endResize", function () { c.positionCheckboxes(); });
            ...
            if (f)
                f.x =
                    e, f.y = d;
        }, destroyItem: function (a) { var b = a.checkbox; n(["legendItem", "legendLine", "legendSymbol", "legendGroup"], function (b) { a[b] && (a[b] = a[b].destroy()); }); b && Ta(a.checkbox); }, destroy: function () {
            ...
            if (!t && (a.legendGroup = d.g("legend-item").attr({ zIndex: 1 }).add(b.scrollGroup), u.drawLegendSymbol(b, a), a.legendItem = t = d.text(e.labelFormat ? Ca(e.labelFormat, a) : e.labelFormatter.call(a), m ? g + h : -h, b.baseline, v).css(x(a.visible ? i : j)).attr({ align: m ? "left" :
                    "right", zIndex: 2 }).add(a.legendGroup), (v ? t : a.legendGroup).on("mouseover", function () { a.setState("hover"); t.css(b.options.itemHoverStyle); }).on("mouseout", function () { t.css(a.visible ? i : j); a.setState(); }).on("click", function (b) { var c = function () { a.setVisible(); }, b = { browserEvent: b }; a.firePointEvent ? a.firePointEvent("legendItemClick", b, c) : z(a, "legendItemClick", b, c); }), b.colorizeItem(a, a.visible), r && w))
            ...
            if (a > f && !e.useHTML) {
                ...
                h.attr({ height: c });
                if (!l)
                    this.nav = l = d.g().attr({ zIndex: 1 }).add(this.group), this.up = d.symbol("triangle", 0, 0, k, k).on("click", function () { b.scroll(-1, j); }).add(l), this.pager = d.text("", 15, 10).css(i.style).add(l), this.down = d.symbol("triangle-down", 0, 0, k, k).on("click", function () { b.scroll(1, j); }).add(l);
                b.scroll(0);
                a = f;
            }
            else if (l)
    ...
    /Trident.*?11\.0/.test(oa) && mb(eb.prototype, "positionItem", function (a, b) { var c = this; setTimeout(function () { a.call(c, b); }); });
    yb.prototype = { init: function (a, b) {
        ...
        initSeries: function (a) { var b = this.options.chart; (b = W[a.type || b.type || b.defaultSeriesType]) || ka(17, !0); b = new b; b.init(this, a); return b; }, addSeries: function (a, b, c) { var d, e = this; a && (b = o(b, !0), z(e, "addSeries", { options: a }, function () { d = e.initSeries(a); e.isDirtyLegend = !0; e.linkSeries(); b && e.redraw(c); })); return d; }, addAxis: function (a, b, c, d) { var e = b ? "xAxis" : "yAxis", f = this.options; new db(this, x(a, { index: this[e].length, isX: b })); f[e] = ja(f[e] || {}); f[e].push(a); o(c, !0) && this.redraw(d); }, isInsidePlot: function (a, b, c) { var d = c ? b : a, a = c ? a : b; return d >= 0 && d <= this.plotWidth && a >= 0 && a <= this.plotHeight; }, adjustTickAmounts: function () { this.options.chart.alignTicks !== !1 && n(this.axes, function (a) { a.adjustTickAmount(); }); this.maxTicks = null; }, redraw: function (a) {
            ...
            if (this.hasCartesianSeries) {
                if (!this.isResizing)
                    this.maxTicks = null, n(b, function (a) { a.setScale(); });
            ...
            n(this.series, function (b) {
                a = a.concat(ub(b.points || [], function (a) { return a.selected; }));
            });
            return a;
        }, getSelectedSeries: function () { return ub(this.series, function (a) { return a.selected; }); }, getStacks: function () {
            var a = this;
            ...
            d.maxTicks = null;
            n(d.axes, function (a) { a.isDirty = !0; a.setScale(); });
            ...
            a.getMargins();
            a.maxTicks = null;
            n(b, function (a) { a.setTickPositions(!0); a.setMaxTicks(); });
            a.adjustTickAmounts();
            a.getMargins();
            a.drawChartBox();
            ...
            n(a.series, function (a) { a.translate(); a.setTooltipPoints(); a.render(); });
            ...
            for (e = c.length; e--;)
                c[e] = c[e].destroy();
            n("title,subtitle,chartBackground,plotBackground,plotBGImage,plotBorder,seriesGroup,clipRect,credits,pointer,scroller,rangeSelector,legend,resetZoomButton,tooltip,renderer".split(","), function (b) { var c = a[b]; c && c.destroy && (a[b] = c.destroy()); });
            if (d)
            ...
            var a = this;
            return !Z && O == O.top && y.readyState !== "complete" || $ && !O.canvg ? ($ ? Tb.push(function () { a.firstRender(); }, a.options.global.canvasToolsURL) : y.attachEvent("onreadystatechange", function () { y.detachEvent("onreadystatechange", a.firstRender); y.readyState === "complete" && a.firstRender(); }), !1) : !0;
        }, firstRender: function () {
            var a = this, b = a.options, c = a.callback;
            if (a.isReadyToRender())
                a.getContainer(), z(a, "init"), a.resetMargins(), a.setChartSize(), a.propFromSeries(), a.getAxes(), n(b.series || [], function (b) { a.initSeries(b); }), a.linkSeries(), z(a, "beforeRender"), a.pointer = new xb(a, b), a.render(), a.renderer.draw(), c && c.apply(a, [a]), n(a.callbacks, function (b) { b.apply(a, [a]); }), a.cloneRenderTo(!0), z(a, "load");
    ...
    Pa.prototype = { init: function (a, b, c) {
            ...
            La(b, f);
            a = o(a, !0);
            c.firePointEvent("remove", null, function () { g = qa(c, h); h.length === e.length && e.splice(g, 1); h.splice(g, 1); d.options.data.splice(g, 1); d.xData.splice(g, 1); d.yData.splice(g, 1); d.zData.splice(g, 1); c.destroy(); d.isDirty = !0; d.isDirtyData = !0; a && f.redraw(); });
    ...
    Q.prototype = { isCartesian: !0, type: "line", pointClass: Pa, sorted: !0, requireSorting: !0, pointAttrToOptions: { stroke: "lineColor", "stroke-width": "lineWidth",
            ...
            n(e, function (a, b) { a.index = b; a.name = a.name || "Series " + (b + 1); });
        }, bindAxes: function () {
            ...
            if (e)
                if (this.options.connectNulls) {
                    ...
                    n(d, function (c, g) { c.y === null ? (g > a + 1 && b.push(d.slice(a + 1, g)), a = g) : g === e - 1 && b.push(d.slice(a + 1, g + 1)); });
            this.segments = b;
            ...
            if (!c.isRemoving)
                c.isRemoving = !0, z(c, "remove", null, function () { c.destroy(); d.isDirtyLegend = d.isDirtyBox = !0; d.linkSeries(); a && d.redraw(b); });
            c.isRemoving = !1;
            ...
            if (b.xAxis)
                J(c, "resize", a), J(b, "destroy", function () { aa(c, "resize", a); }), a(), b.invertGroups = a;
    ...
    X = { type: "pie", isCartesian: !1, pointClass: ha(Pa, { init: function () {
        ...
        }, setData: function (a, b) { Q.prototype.setData.call(this, a, !1); this.processData(); this.generatePoints(); o(b, !0) && this.chart.redraw(); }, generatePoints: function () {
            ...
            return Na(a, function (a, b) { h = /%$/.test(a); d = b < 2 || b === 2 && h; return (h ? [e, f, g, g][b] * C(a) / 100 : a) + (d ? c : 0); });
            ...
            this.getX = function (b, c) { h = R.asin((b - a[1]) / (a[2] / 2 + l)); return a[0] + (c ? -1 : 1) * V(h) * (a[2] / 2 + l); };
            for (m = 0; m < n; m++) {
                o = k[m];
                f = j + b * i;
                if (!c || o.visible)
            ...
            var a = this, b = a.data, c, d = a.chart, e = a.options.dataLabels, f = o(e.connectorPadding, 10), g = o(e.connectorWidth, 1), h = d.plotWidth, d = d.plotHeight, i, j, k = o(e.softConnector, !0), l = e.distance, m = a.center, p = m[2] / 2, q = m[1], u = l > 0, r, w, v, x, C = [[], []], y, z, E, H, B, D = [0, 0, 0, 0], I = function (a, b) { return b.y - a.y; };
