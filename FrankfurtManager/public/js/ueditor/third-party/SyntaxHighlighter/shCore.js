...
(function (undefined) {
    ...
    XRegExp.addToken(/(?:\s+|#.*)+/, function (match) {
        // Keep tokens separated unless the following token is a quantifier
        return nativ.test.call(quantifier, match.input.slice(match.index + match[0].length)) ? "" : "(?:)";
    }, XRegExp.OUTSIDE_CLASS, function () { return this.hasFlag("x"); });
...
(function () {
    ...
    function Brush() {
        ...
        var funcs = 'abs accept alarm atan2 bind binmode chdir chmod chomp chop chown chr ' +
            ...
            // feature
            'say';
        var keywords = 'bless caller continue dbmclose dbmopen die do dump else elsif eval exit ' +
...
//# sourceMappingURL=shCore.js.map 
//# sourceMappingURL=shCore.js.map