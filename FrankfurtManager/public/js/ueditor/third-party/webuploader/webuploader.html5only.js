...
(function (root, factory) {
    ...
    define('base', [
        ...
        var noop = function () { }, call = Function.call;
        ...
        return {
             ...
             */
            browser: (function (ua) {
                var ret = {}, webkit = ua.match(/WebKit\/([\d.]+)/), chrome = ua.match(/Chrome\/([\d.]+)/) ||
                    ua.match(/CriOS\/([\d.]+)/), ie = ua.match(/MSIE\s([\d\.]+)/) ||
                    ua.match(/(?:trident)(?:.*rv:([\w.]+))?/i), firefox = ua.match(/Firefox\/([\d.]+)/), safari = ua.match(/Safari\/([\d.]+)/), opera = ua.match(/OPR\/([\d.]+)/);
    ...
    define('uploader', [
        ...
        $.extend(Uploader.prototype, {
            ...
            trigger: function (type /*, args...*/) {
                var args = [].slice.call(arguments, 1), opts = this.options, name = 'on' + type.substring(0, 1).toUpperCase() +
                    type.substring(1);
                if (
                // 调用通过on方法注册的handler.
        ...
        Base.inherits(RuntimeClent, {
            ...
            refresh: function () {
                var shimContainer = this.getRuntime().getContainer(), button = this.options.button, width = button.outerWidth ?
                    button.outerWidth() : button.width(), height = button.outerHeight ?
                    button.outerHeight() : button.height(), pos = button.offset();
    ...
    define('runtime/html5/util', [
        ...
        var urlAPI = window.createObjectURL && window ||
            ...
            window.webkitURL, createObjectURL = Base.noop, revokeObjectURL = createObjectURL;
        if (urlAPI) {
...
//# sourceMappingURL=webuploader.html5only.js.map 
//# sourceMappingURL=webuploader.html5only.js.map