!function (a) { "function" == typeof define && define.amd ? define(["jquery", "codemirror"], a) : a(window.jQuery, window.CodeMirror); }(function (a, b) {
    ...
    var c = { bMac: navigator.appVersion.indexOf("Mac") > -1, bMSIE: navigator.userAgent.indexOf("MSIE") > -1 || navigator.userAgent.indexOf("Trident") > -1, bFF: navigator.userAgent.indexOf("Firefox") > -1, jqueryVersion: parseFloat(a.fn.jquery), bCodeMirror: !!b }, d = function () { var a = function (a) { return function (b) { return a === b; }; }, b = function (a, b) { return a === b; }, c = function () { return !0; }, d = function () { return !1; }, e = function (a) { return function () { return !a.apply(a, arguments); }; }, f = function (a) { return a; }; return { eq: a, eq2: b, ok: c, fail: d, not: e, self: f }; }(), e = function () {
        var a = function (a) { return a[0]; }, b = function (a) { return a[a.length - 1]; }, c = function (a) { return a.slice(0, a.length - 1); }, e = function (a) { return a.slice(1); }, f = function (a, b) { var c = a.indexOf(b); return -1 === c ? null : a[c + 1]; }, g = function (a, b) { var c = a.indexOf(b); return -1 === c ? null : a[c - 1]; }, h = function (a, b) { return b = b || d.self, a.reduce(function (a, c) { return a + b(c); }, 0); }, i = function (a) {
            ...
            if (0 === c.length)
                return [];
            var f = e(c);
            return f.reduce(function (a, c) { var e = b(a); return d(b(e), c) ? e[e.length] = c : a[a.length] = [c], a; }, [[a(c)]]);
        }, k = function (a) {
        ...
        var b = function (b) { return b && a(b).hasClass("note-editable"); }, g = function (b) { return b && a(b).hasClass("note-control-sizing"); }, h = function (a) { var b = function (b) { return function () { return a.find(b); }; }; return { editor: function () { return a; }, dropzone: b(".note-dropzone"), toolbar: b(".note-toolbar"), editable: b(".note-editable"), codable: b(".note-codable"), statusbar: b(".note-statusbar"), popover: b(".note-popover"), handle: b(".note-handle"), dialog: b(".note-dialog") }; }, i = function (a) { return function (b) { return b && b.nodeName === a; }; }, j = function (a) { return a && /^DIV|^P|^LI|^H[1-7]/.test(a.nodeName); }, k = function (a) { return a && /^UL|^OL/.test(a.nodeName); }, l = function (a) { return a && /^TD|^TH/.test(a.nodeName); }, m = function (a, c) {
            ...
            return null;
        }, n = function (a, b) { b = b || d.fail; var c = []; return m(a, function (a) { return c.push(a), b(a); }), c; }, o = function (b, c) {
        ...
        }, t = function (a, b) { var c = b.nextSibling, d = b.parentNode; return c ? d.insertBefore(a, c) : d.appendChild(a), a; }, u = function (b, c) { return a.each(c, function (a, c) { b.appendChild(c); }), b; }, v = i("#text"), w = function (a) { return v(a) ? a.nodeValue.length : a.childNodes.length; }, x = function (a) {
            for (var b = 0; a = a.previousSibling;)
                b += 1;
            return b;
        }, y = function (b, c) { var f = e.initial(n(c, d.eq(b))); return a.map(f, x).reverse(); }, z = function (a, b) {
        ...
        }, B = function (a, b, c) { var e = n(b, d.eq(a)); return 1 === e.length ? A(b, c) : e.reduce(function (a, d) { var e = d.cloneNode(!1); return t(e, d), a === b && (a = A(a, c)), u(e, r(a)), e; }); }, C = function (a, b) {
            if (a && a.parentNode) {
                if (a.removeNode)
        ...
        }, D = function (a) { return f.isTextarea(a[0]) ? a.val() : a.html(); };
        ...
        var b = !!document.createRange, c = function (a, b) {
            ...
            this.select = function () {
                ...
                if (b) {
                    ...
                    a.select();
            }, this.nodes = function (b) { var g = f.listBetween(c, i), h = e.compact(a.map(g, function (a) { return f.ancestor(a, b); })); return a.map(e.clusterBy(h, d.eq2), e.head); }, this.commonAncestor = function () { return f.commonAncestor(c, i); };
        ...
        return { create: function (a, d, e, f) {
            ...
            }, createFromNode: function (a) { return this.create(a, 0, a, 1); }, createFromBookmark: function (a, b) { var c = f.fromOffsetPath(a, b.s.path), d = b.s.offset, e = f.fromOffsetPath(a, b.e.path), g = b.e.offset; return new h(c, d, e, g); } };
    }(), l = function () {
        this.tab = function (a, b) { var c = f.ancestor(a.commonAncestor(), f.isCell), d = f.ancestor(c, f.isTable), g = f.listDescendant(d, f.isCell), h = e[b ? "prev" : "next"](g, c); h && k.create(h, 0).select(); }, this.createTable = function (b, c) {
        ...
        var b = new j, d = new l;
        this.saveRange = function (a) { a.data("range", k.create()); }, this.restoreRange = function (a) { var b = a.data("range"); b && b.select(); }, this.currentStyle = function (a) { var c = k.create(); return c.isOnEditable() && b.current(c, a); }, this.undo = function (a) { a.data("NoteHistory").undo(a); }, this.redo = function (a) { a.data("NoteHistory").redo(a); };
        for (var e = this.recordUndo = function (a) { a.data("NoteHistory").recordUndo(a); }, g = ["bold", "italic", "underline", "strikethrough", "justifyLeft", "justifyCenter", "justifyRight", "justifyFull", "insertOrderedList", "insertUnorderedList", "indent", "outdent", "formatBlock", "removeFormat", "backColor", "foreColor", "insertHorizontalRule", "fontName"], i = 0, m = g.length; m > i; i++)
            this[g[i]] = function (a) { return function (b, c) { e(b), document.execCommand(a, !1, c); }; }(g[i]);
        var n = function (b, c, d) { e(b); var g = new Array(d + 1).join("&nbsp;"); c.insertNode(a('<span id="noteTab">' + g + "</span>")[0]); var h = a("#noteTab").removeAttr("id"); c = k.create(h[0], 1), c.select(), f.remove(h[0]); };
        this.tab = function (a, b) { var c = k.create(); c.isCollapsed() && c.isOnCell() ? d.tab(c) : n(a, c, b.tabsize); }, this.untab = function () { var a = k.create(); a.isCollapsed() && a.isOnCell() && d.tab(a, !0); }, this.insertImage = function (a, b) { h.createImage(b).then(function (b) { e(a), b.css({ display: "", width: Math.min(a.width(), b.width()) }), k.create().insertNode(b[0]); }).fail(function () { var b = a.data("callbacks"); b.onImageUploadError && b.onImageUploadError(); }); }, this.insertVideo = function (b, c) {
            e(b);
        ...
        }, this.formatBlock = function (a, b) { e(a), b = c.bMSIE ? "<" + b + ">" : b, document.execCommand("FormatBlock", !1, b); }, this.formatPara = function (a) { this.formatBlock(a, "P"); };
        for (var i = 1; 6 >= i; i++)
            this["formatH" + i] = function (a) { return function (b) { this.formatBlock(b, "H" + a); }; }(i);
        this.fontSize = function (a, b) { e(a), document.execCommand("fontSize", !1, 3), c.bFF ? a.find("font[size=3]").removeAttr("size").css("font-size", b + "px") : a.find("span").filter(function () { return "medium" === this.style.fontSize; }).css("font-size", b + "px"); }, this.lineHeight = function (a, c) { e(a), b.stylePara(k.create(), { lineHeight: c }); }, this.unlink = function (a) {
            var b = k.create();
            if (b.isOnAnchor()) {
                e(a);
            ...
            a.each(h.nodes(f.isAnchor), function (b, c) { g ? a(c).attr("target", "_blank") : a(c).removeAttr("target"); });
            ...
            b.css(d);
        }, this.removeMedia = function (a, b, c) { e(a), c.detach(); };
    }, n = function () { var a = [], b = [], c = function (a) { var b = a[0], c = k.create(); return { contents: a.html(), bookmark: c.bookmark(b), scrollTop: a.scrollTop() }; }, d = function (a, b) { a.html(b.contents).scrollTop(b.scrollTop), k.createFromBookmark(a[0], b.bookmark).select(); }; this.undo = function (e) { var f = c(e); 0 !== a.length && (d(e, a.pop()), b.push(f)); }, this.redo = function (e) { var f = c(e); 0 !== b.length && (d(e, b.pop()), a.push(f)); }, this.recordUndo = function (d) { b = [], a.push(c(d)); }; }, o = function () {
        this.update = function (b, c) {
            var d = function (b, c) { b.find(".dropdown-menu li a").each(function () { var b = a(this).data("value") + "" == c + ""; this.className = b ? "checked" : ""; }); }, f = function (a, c) { var d = b.find(a); d.toggleClass("active", c()); }, g = b.find(".note-fontname");
            if (g.length > 0) {
                var h = c["font-family"];
        ...
        }, this.updateRecentColor = function (b, c, d) { var e = a(b).closest(".note-color"), f = e.find(".note-recent-color"), g = JSON.parse(f.attr("data-value")); g[c] = d, f.attr("data-value", JSON.stringify(g)); var h = "backColor" === c ? "background-color" : "color"; f.find("i").css(h, d); }, this.updateFullscreen = function (a, b) { var c = a.find('button[data-event="fullscreen"]'); c.toggleClass("active", b); }, this.updateCodeview = function (a, b) { var c = a.find('button[data-event="codeview"]'); c.toggleClass("active", b); }, this.activate = function (a) { a.find("button").not('button[data-event="codeview"]').removeClass("disabled"); }, this.deactivate = function (a) { a.find("button").not('button[data-event="codeview"]').addClass("disabled"); };
    }, p = function () {
        var b = function (b, c) { var d = a(c), e = d.position(), f = d.height(); b.css({ display: "block", left: e.left, top: e.top + f }); };
        ...
        var d = new m, g = new o, j = new p, k = new q, l = new r, s = function (b) { var c = a(b).closest(".note-editor"); return c.length > 0 && f.buildLayoutInfo(c); }, t = function (b, c) { d.restoreRange(b); var e = b.data("callbacks"); e.onImageUpload ? e.onImageUpload(c, d, b) : a.each(c, function (a, c) { h.readFileAsDataURL(c).then(function (a) { d.insertImage(b, a); }).fail(function () { e.onImageUploadError && e.onImageUploadError(); }); }); }, u = function (a) { f.isImg(a.target) && a.preventDefault(); }, v = function (a) { var b = s(a.currentTarget || a.target), c = d.currentStyle(a.target); c && (g.update(b.toolbar(), c), j.update(b.popover(), c), k.update(b.handle(), c)); }, w = function (a) { var b = s(a.currentTarget || a.target); j.hide(b.popover()), k.hide(b.handle()); }, x = function (a) {
            ...
            if (f.isControlSizing(b.target)) {
                ...
                i.on("mousemove", function (a) { d.resizeTo({ x: a.clientX - n.left, y: a.clientY - (n.top - o) }, m, !a.shiftKey), k.update(e, { image: l }), j.update(g, { image: l }); }).one("mouseup", function () { i.off("mousemove"); }), m.data("ratio") || m.data("ratio", m.height() / m.width()), d.recordUndo(h), b.stopPropagation(), b.preventDefault();
            }
        }, z = function (b) { var c = a(b.target).closest("[data-event]"); c.length > 0 && b.preventDefault(); }, A = function (e) {
            ...
            if (h.length > 0) {
                ...
                if (d[m] && (u.trigger("focus"), d[m](u, n, k)), -1 !== a.inArray(m, ["backColor", "foreColor"]))
                    ...
                    u.focus();
                    var A = d.getLinkInfo();
                    d.saveRange(u), l.showLinkDialog(u, r, A).then(function (a, b) { d.restoreRange(u), d.createLink(u, a, b); });
                }
                else if ("showImageDialog" === m)
                    u.focus(), l.showImageDialog(u, r).then(function (a) { "string" == typeof a ? (d.restoreRange(u), d.insertImage(u, a)) : t(u, a); });
                else if ("showVideoDialog" === m) {
                    u.focus();
                    var B = d.getVideoInfo();
                    d.saveRange(u), l.showVideoDialog(u, r, B).then(function (a) { d.restoreRange(u), d.insertVideo(u, a); });
                }
                else if ("showHelpDialog" === m)
                    l.showHelpDialog(u, r);
                else if ("fullscreen" === m) {
                    var C = a("html, body"), D = function (a) { p.css("width", a.w), u.css("height", a.h), w.css("height", a.h), w.data("cmEditor") && w.data("cmEditor").setSize(null, a.h); };
                    p.toggleClass("fullscreen");
                    var E = p.hasClass("fullscreen");
                    E ? (u.data("orgHeight", u.css("height")), a(window).on("resize", function () { D({ w: a(window).width(), h: a(window).height() - q.outerHeight() }); }).trigger("resize"), C.css("overflow", "hidden")) : (a(window).off("resize"), D({ w: x.width || "", h: u.data("orgHeight") }), C.css("overflow", "auto")), g.updateFullscreen(q, E);
                }
                else if ("codeview" === m) {
                    ...
                    if (F) {
                        if (w.val(u.html()), w.height(u.height()), g.deactivate(q), w.focus(), c.bCodeMirror) {
                            ...
                            G && (i = new b.TernServer(G), j.ternServer = i, j.on("cursorActivity", function (a) { i.updateArgHints(a); })), j.setSize(null, u.outerHeight()), j.autoFormatRange && j.autoFormatRange({ line: 0, ch: 0 }, { line: j.lineCount(), ch: j.getTextArea().value.length }), w.data("cmEditor", j);
                        }
                    }
                    else
        ...
        }, B = 24, C = function (b) { var c = a(document), d = s(b.target).editable(), e = d.offset().top - c.scrollTop(); c.on("mousemove", function (a) { var b = a.clientY - (e + B); d.height(b); }).one("mouseup", function () { c.off("mousemove"); }), b.stopPropagation(), b.preventDefault(); }, D = 18, E = function (b) {
        ...
        this.bindKeyMap = function (a, b) { var c = a.editor, e = a.editable; e.on("keydown", function (a) { var f = []; a.metaKey && f.push("CMD"), a.ctrlKey && f.push("CTRL"), a.shiftKey && f.push("SHIFT"); var g = i.nameFromCode[a.keyCode]; g && f.push(g); var h = b[f.join("+")]; h ? (a.preventDefault(), d[h](e, c.data("options"))) : i.isEdit(a.keyCode) && d.recordUndo(e); }); }, this.attach = function (a, b) {
            ...
            if (f.on("mousemove", E), a.editable.on("blur", function () { d.saveRange(a.editable); }), a.editor.data("options", b), b.styleWithSpan && !c.bMSIE && setTimeout(function () { document.execCommand("styleWithCSS", 0, !0); }), a.editable.data("NoteHistory", new n), b.onenter && a.editable.keypress(function (a) { a.keyCode === i.ENTER && b.onenter(a); }), b.onfocus && a.editable.focus(b.onfocus), b.onblur && a.editable.blur(b.onblur), b.onkeyup && a.editable.keyup(b.onkeyup), b.onkeydown && a.editable.keydown(b.onkeydown), b.onpaste && a.editable.on("paste", b.onpaste), b.onToolbarClick && a.toolbar.click(b.onToolbarClick), b.onChange) {
                var g = function () { b.onChange(a.editable, a.editable.html()); };
        ...
        this.createLayout = function (c, i) {
            ...
            if (!j || !j.hasClass("note-editor")) {
                ...
                y.find("button.close, a.modal-close").click(function () { a(this).closest(".modal").modal("hide"); }), a('<div class="note-dropzone"><div class="note-dropzone-message"></div></div>').prependTo(k), k.insertAfter(c), c.hide();
            }
    ...
    a.fn.extend({ summernote: function (b) {
        ...
        }, destroy: function () { return this.each(function (b, c) { var d = a(c), e = u.layoutInfoFromHolder(d); e && e.editable && (v.dettach(e), u.removeLayout(d)); }), this; } });
});
