...
(function (B) {
    ...
    B.color.make = function (F, E, C, D) {
        ...
        G.normalize = function () { function H(J, K, I) { return K < J ? J : (K > I ? I : K); } G.r = H(0, parseInt(G.r), 255); G.g = H(0, parseInt(G.g), 255); G.b = H(0, parseInt(G.b), 255); G.a = H(0, G.a, 1); return G; };
...
(function ($) {
    function Plot(placeholder, data_, options_, plugins) {
        ...
        function setupCanvases() {
            var reused, existingCanvas = placeholder.children("../../../../../error/ie.html" /*tpa=http://www.zi-han.net/theme/hplus/js/plugins/flot/canvas.base*/), existingOverlay = placeholder.children("canvas.overlay");
