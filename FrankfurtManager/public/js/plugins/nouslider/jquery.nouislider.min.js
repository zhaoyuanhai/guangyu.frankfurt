...
(function (b) {
    ...
    b.classVal = function (a, b, d, l) { "string" === typeof a && "boolean" === typeof l && (b && (g[a] = b), d && (q[a] = d), u[a] = l); };
    b.fn.val = function () { var a = Array.prototype.slice.call(arguments, 0), e, d; return a.length ? this.each(function () { (e = h(!0, this)) ? (d = u[e] ? b(this) : this, d[q[e]].apply(this, a)) : n.apply(b(this), a); }) : (e = h(!1, this)) ? (d = u[e] ? this : this[0], d[g[e]].apply(d)) : n.apply(this); };
})(window.jQuery ||
    window.Zepto); /*
...
(function (b) {
    function h(a, b, d) {
        if ((a[b] || a[d]) && a[b] === a[d])
            throw Error("(Link) '" + b + "' can't match '" + d + "'.'");
    }
    function n(a) {
        void 0 === a && (a = {});
        if ("object" !== typeof a)
        ...
        b(q).each(function (b, l) {
            if (void 0 === a[l])
                ...
                if ("decimals" === l && (0 > a[l] || 7 < a[l]))
                    throw Error("(Format) 'format.decimals' option must be between 0 and 7.");
                e[l] = a[l];
            }
            else
                throw Error("(Format) 'format." + l + "' must be a " + typeof u[b] +
                    ".");
        });
        h(e, "mark", "thousand");
        h(e, "prefix", "negative");
    ...
    function g(a, e) { "object" !== typeof a && b.error("(Link) Initialize with an object."); return new g.prototype.p(a.target || function () { }, a.method, a.format || {}, e); }
    var q = "decimals mark thousand prefix postfix encoder decoder negative negativeBefore to from".split(" "), u = [2, ".", "", "", "", function (a) { return a; }, function (a) { return a; }, "-", "", function (a) { return a; }, function (a) { return a; }];
    n.prototype.a = function (a) { return this.r[a]; };
    n.prototype.L = function (a) { function b(a) { return a.split("").reverse().join(""); } a = this.a("encoder")(a); var d = this.a("decimals"), l = "", g = "", h = "", n = ""; 0 === parseFloat(a.toFixed(d)) && (a = "0"); 0 > a && (l = this.a("negative"), g = this.a("negativeBefore")); a = Math.abs(a).toFixed(d).toString(); a = a.split("."); this.a("thousand") ? (h = b(a[0]).match(/.{1,3}/g), h = b(h.join(b(this.a("thousand"))))) : h = a[0]; this.a("mark") && 1 < a.length && (n = this.a("mark") + a[1]); return this.a("to")(g + this.a("prefix") + l + h + n + this.a("postfix")); };
    n.prototype.w =
        function (a) {
    ...
    g.prototype.K = function (a, e) { this.method = e || "html"; this.j = b(a.replace("-tooltip-", "") || "<div/>")[0]; };
    g.prototype.H = function (a) { this.method = "val"; this.j = document.createElement("input"); this.j.name = a; this.j.type = "hidden"; };
    g.prototype.G = function (a) { function e(a, b) { return [b ? null : a, b ? a : null]; } var d = this; this.method = "val"; this.target = a.on("change", function (a) { d.B.val(e(b(a.target).val(), d.t), { link: d, set: !0 }); }); };
    ...
    g.prototype.write = function (a, b, d, g) {
        if (!this.update || !1 !== g)
            if (this.u = a, this.F = a =
                ...
                this.method.call(this.target[0] || d[0], a, b, d);
            else
                this.target[this.method](a, b, d);
    };
    g.prototype.q = function (a) { this.g = new n(b.extend({}, a, this.g instanceof n ? this.g.r : this.g)); };
    g.prototype.J = function (a) { this.B = a; };
    g.prototype.I = function (a) { this.t = a; };
    g.prototype.format = function (a) { return this.g.L(a); };
    g.prototype.A = function (a) { return this.g.w(a); };
...
(function (b) {
    ...
    function n(a) { return b.isArray(a) ? a : [a]; }
    function g(a, c) { a.addClass(c); setTimeout(function () { a.removeClass(c); }, 300); }
    function q(a, c) { return 100 * c / (a[1] - a[0]); }
    function u(a, c) {
        if (c >= a.d.slice(-1)[0])
            return 100;
        for (var b = 1, f, d, e; c >= a.d[b];)
            b++;
        f = a.d[b - 1];
        d = a.d[b];
        e = a.c[b - 1];
    ...
    function a(a, c) {
        if (100 <= c)
            return a.d.slice(-1)[0];
        for (var b = 1, f, d, e; c >= a.c[b];)
            b++;
        f =
            a.d[b - 1];
        d = a.d[b];
    ...
    function e(a, c) {
        for (var b = 1, f; c >= a.c[b];)
            b++;
        if (a.m)
            return f = a.c[b - 1], b = a.c[b], c - f > (b - f) / 2 ? b : f;
    ...
    function l(a, c) {
        if ("object" !== typeof c || b.isArray(c))
    ...
    function z(a, c) {
        "number" === typeof c && (c = [c]);
        if (!b.isArray(c) || !c.length || 2 < c.length)
    ...
    function M(a, c) {
        ...
        b.each(f, function (b, d) {
            if (void 0 === a[b]) {
                if (d.e)
                    throw Error("noUiSlider: '" + b + "' is required.");
                return !0;
            }
            d.f(e, a[b], c);
        });
    ...
    function N(a, c) { var d = b("<div><div/></div>").addClass(k[2]), f = ["-lower", "-upper"]; a.dir && f.reverse(); d.children().addClass(k[3] + " " + k[3] + f[c]); return d; }
    function O(a, c) { c.j && (c = new b.Link({ target: b(c.j).clone().appendTo(a), method: c.method, format: c.g }, !0)); return c; }
    function P(a, c) {
        var d, f = [];
        for (d = 0; d < a.b; d++) {
    ...
    function Q(a, c, b) {
        switch (a) {
            case 1:
                ...
                b[0].addClass(k[6]);
                break;
            case 3: b[1].addClass(k[6]);
            case 2: b[0].addClass(k[7]);
            case 0: c.addClass(k[6]);
        }
    }
    function R(a, b) {
        var d, f = [];
        for (d = 0; d < a.b; d++)
            f.push(N(a, d).appendTo(b));
        return f;
    }
    function S(a, c) { c.addClass([k[0], k[8 + a.dir], k[4 + a.k]].join(" ")); return b("<div/>").appendTo(c).addClass(k[1]); }
    function T(d, c, h) {
        function f() { return r[["width", "height"][c.k]](); }
        function l(a) {
            var b, c = [s.val()];
        ...
        function q(d, p, f) {
            ...
            if (p === v[g])
                return 1 === m.length ? !1 : p === H || p === l ? 0 : !1;
            d.css(c.style, p + "%");
            d.is(":first-child") && d.toggleClass(k[17], 50 < p);
            v[g] = p;
            c.dir && (p = 100 - p);
            b(w[g]).each(function () { this.write(a(c, p), d.children(), s); });
            return !0;
        }
        function G(a, b, c) { c || g(s, k[14]); q(a, b, !1); l(["slide", "set", "change"]); }
        function t(a, b, d, f) {
            a =
                a.replace(/\s/g, ".nui ") + ".nui";
            b.on(a, function (a) {
                var b = s.attr("disabled");
                if (s.hasClass(k[14]) || void 0 !== b && null !== b)
                    return !1;
                a.preventDefault();
                ...
                if (p || e)
                    e || void 0 !== window.pageXOffset || (window.pageXOffset = document.documentElement.scrollLeft, window.pageYOffset =
        ...
        function y(a, b) { var c = b.b || m, d, e = !1, e = 100 * (a.l - b.start) / f(), g = c[0][0] !== m[0][0] ? 1 : 0; var k = b.D; d = e + k[0]; e += k[1]; 1 < c.length ? (0 > d && (e += Math.abs(d)), 100 < e && (d -= e - 100), d = [Math.max(Math.min(d, 100), 0), Math.max(Math.min(e, 100), 0)]) : d = [d, e]; e = q(c[0], d[g], 1 === c.length); 1 < c.length && (e = q(c[1], d[g ? 0 : 1], !1) || e); e && l(["slide"]); }
        function z(a) {
        ...
        function C(a, c) { 1 === c.b.length && c.b[0].children().addClass(k[15]); a.stopPropagation(); t(x.move, E, y, { start: a.l, b: c.b, D: [v[0], v[m.length - 1]] }); t(x.end, E, z, null); a.cursor && (b("body").css("cursor", b(a.target).css("cursor")), 1 < m.length && s.addClass(k[12]), b("body").on("../../../../../error/ie.html" /*tpa=http://www.zi-han.net/theme/hplus/js/plugins/nouslider/selectstart.nui*/, !1)); }
        function A(a) {
            var d = a.l, e = 0;
            a.stopPropagation();
            b.each(m, function () { e += this.offset()[c.style]; });
            e = d < e / 2 || 1 === m.length ?
                0 : 1;
            d -= r.offset()[c.style];
            d = 100 * d / f();
        ...
        function B(a) { var b = (a = a.l < r.offset()[c.style]) ? 0 : 100; a = a ? 0 : m.length - 1; G(m[a], b, !1); }
        ...
        (function (a) {
            ...
            if (!a.fixed)
                for (b = 0; b < m.length; b++)
                    t(x.start, m[b].children(), C, { b: [m[b]] });
        ...
        d.vSet = function () {
            ...
            1 === t.length && (a = 1);
            for (r = 0; r < a; r++)
                h = e || w[r % 2][0], h = h.A(t[r % 2]), !1 !== h && (h = u(c, h), c.dir && (h = 100 - h), !0 !== q(m[r % 2], h, !0) && b(w[r % 2]).each(function (a) {
                    if (!a)
                        return F = this.u, !0;
        ...
        d.destroy = function () { b.each(w, function () { b.each(this, function () { this.target && this.target.off(".nui"); }); }); b(this).off(".nui").removeClass(k.join(" ")).empty(); return h; };
        s.val(c.start);
    }
    function U(a) {
        if (!this.length)
    ...
    function V(a) { return this.each(function () { var c = b(this).val(), d = this.destroy(), e = b.extend({}, d, a); b(this).noUiSlider(e); d.start === e.start && b(this).val(c); }); }
    ...
    b.fn.noUiSlider = function (a, b) { return (b ? V : U).call(this, a); };
