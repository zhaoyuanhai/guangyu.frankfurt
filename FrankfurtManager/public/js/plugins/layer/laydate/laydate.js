...
;
!function (a) {
    var b = { path: "", defSkin: "default", format: "YYYY-MM-DD", min: "1900-01-01 00:00:00", max: "2099-12-31 23:59:59", isv: !1 }, c = {}, d = document, e = "createElement", f = "getElementById", g = "getElementsByTagName", h = ["laydate_box", "laydate_void", "laydate_click", "LayDateSkin", "skins/", "../../../../../../error/ie.html" /*tpa=http://www.zi-han.net/laydate.css*/];
    a.laydate = function (b) {
    ...
    }, laydate.v = "1.1", c.getPath = function () { var a = document.scripts, c = a[a.length - 1].src; return b.path ? b.path : c.substring(0, c.lastIndexOf("/") + 1); }(), c.use = function (a, b) { var f = d[e]("link"); f.type = "text/css", f.rel = "stylesheet", f.href = c.getPath + a + h[5], b && (f.id = b), d[g]("head")[0].appendChild(f), f = null; }, c.trim = function (a) { return a = a || "", a.replace(/^\s|\s$/g, "").replace(/\s+/g, " "); }, c.digit = function (a) { return 10 > a ? "0" + (0 | a) : a; }, c.stopmp = function (b) { return b = b || a.event, b.stopPropagation ? b.stopPropagation() : b.cancelBubble = !0, this; }, c.each = function (a, b) {
        ...
        if (d = a.elem ? b(a.elem) : g, f && g.tagName) {
            ...
            e = a.event || "click", c.each((0 | d.length) > 0 ? d : [d], function (b, d) { c.stopMosup(e, d), c.on(d, e, function (b) { c.stopmp(b), d !== c.elem && (c.view(d, a), c.reshow()); }); });
        ...
        switch (b) {
            ...
            case "6.1":
                c = "儿童";
                break;
            case "../../../../../../error/ie.html" /*tpa=http://www.zi-han.net/theme/hplus/js/plugins/layer/laydate/9.10*/:
                c = "教师";
                break;
            case "10.1": c = "国庆";
        }
