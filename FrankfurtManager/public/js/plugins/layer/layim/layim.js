...
!function (win, undefined) {
    var config = {
        ...
        right: -232,
        api: {
            friend: '../../../../../../error/ie.html' /*tpa=http://www.zi-han.net/theme/hplus/js/plugins/layer/layim/js/plugins/layer/layim/data/friend.json*/,
            group: '../../../../../../error/ie.html' /*tpa=http://www.zi-han.net/theme/hplus/js/plugins/layer/layim/js/plugins/layer/layim/data/group.json*/,
            chatlog: '../../../../../../error/ie.html' /*tpa=http://www.zi-han.net/theme/hplus/js/plugins/layer/layim/js/plugins/layer/layim/data/chatlog.json*/,
            groups: '../../../../../../error/ie.html' /*tpa=http://www.zi-han.net/theme/hplus/js/plugins/layer/layim/js/plugins/layer/layim/data/groups.json*/,
            sendurl: '' //发送消息接口
        },
        user: {
            name: '游客',
    ...
    xxim.getGroups = function (param) {
        var keys = param.type + param.id, str = '', groupss = xxim.chatbox.find('#layim_group' + keys);
    ...
    xxim.getDates = function (index) {
        var api = [config.api.friend, config.api.group, config.api.chatlog], node = xxim.node, myf = node.list.eq(index);
