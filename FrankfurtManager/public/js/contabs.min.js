$(function () {
    ...
    function s() {
        ...
        if ($(this).parents(".J_menuTab").hasClass("active")) {
            ...
            $(this).parents(".J_menuTab").remove(), $(".J_mainContent .J_iframe").each(function () { return $(this).data("id") == t ? ($(this).remove(), !1) : void 0; }), e($(".J_menuTab.active"));
        return !1;
    }
    ...
    function c() { var t = $('.J_iframe[data-id="' + $(this).data("id") + '"]'), e = t.attr("src"), a = layer.load(); t.attr("src", e).load(function () { layer.close(a); }); }
...
//# sourceMappingURL=contabs.min.js.map 
//# sourceMappingURL=contabs.min.js.map