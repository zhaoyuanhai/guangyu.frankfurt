...
+function (a) {
    ...
    if (!a.fn.tooltip)
        throw new Error("../../../error/ie.html" /*tpa=http://www.zi-han.net/theme/hplus/js/Popover requires tooltip.js*/);
    ...
    "use strict";
    function b(b) { return this.each(function () { var d = a(this), e = d.data("../../../error/ie.html" /*tpa=http://www.zi-han.net/theme/hplus/js/bs.tab*/); e || d.data("../../../error/ie.html" /*tpa=http://www.zi-han.net/theme/hplus/js/bs.tab*/, e = new c(this)), "string" == typeof b && e[b](); }); }
    var c = function (b) { this.element = a(b); };
    c.VERSION = "3.3.5", c.TRANSITION_DURATION = 150, c.prototype.show = function () {
        var b = this.element, c = b.closest("ul:not(.dropdown-menu)"), d = b.data("target");
        if (d || (d = b.attr("href"), d = d && d.replace(/.*(?=#[^\s]*$)/, "")), !b.parent("li").hasClass("active")) {
            var e = c.find(".active:last a"), f = a.Event("../../../error/ie.html" /*tpa=http://www.zi-han.net/theme/hplus/js/hide.bs.tab*/, { relatedTarget: b[0] }), g = a.Event("../../../error/ie.html" /*tpa=http://www.zi-han.net/theme/hplus/js/show.bs.tab*/, { relatedTarget: e[0] });
            if (e.trigger(f), b.trigger(g), !g.isDefaultPrevented() && !f.isDefaultPrevented()) {
                var h = a(d);
                this.activate(b.closest("li"), c), this.activate(h, h.parent(), function () { e.trigger({ type: "../../../error/ie.html" /*tpa=http://www.zi-han.net/theme/hplus/js/hidden.bs.tab*/, relatedTarget: b[0] }), b.trigger({ type: "../../../error/ie.html" /*tpa=http://www.zi-han.net/theme/hplus/js/shown.bs.tab*/, relatedTarget: e[0] }); });
            }
        }
...
//# sourceMappingURL=bootstrap.min.js-v=3.3.5.js.map 
//# sourceMappingURL=bootstrap.min.js-v=3.3.5.js.map