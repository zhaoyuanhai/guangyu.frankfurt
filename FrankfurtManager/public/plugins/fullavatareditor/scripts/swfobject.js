...
var swfobject = function () {
    ...
    function A() { return !a && F("../../../../../error/ie.html" /*tpa=http://www.zi-han.net/theme/hplus/plugins/fullavatareditor/scripts/6.0.65*/) && (M.win || M.mac) && !(M.wk && M.wk < 312); }
    ...
    return { registerObject: function (ab, X, aa, Z) {
        ...
        }, switchOffAutoHideShow: function () { m = false; }, ua: M, getFlashPlayerVersion: function () { return { major: M.pv[0], minor: M.pv[1], release: M.pv[2] }; }, hasFlashPlayerVersion: F, createSWF: function (Z, Y, X) {
            if (M.w3) {
                return u(Z, Y, X);
            }
            else {
